        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 space-y-6">
                    ...
                    <div class="text-center">
                        <h1 class="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-gray-100">
                            The <span class="text-tldr-primary">TL;DR AI</span> Story
                        </h1>
                        <p class="mt-4 text-lg text-gray-700 dark:text-gray-300">
                            At <span class="text-tldr-primary">TL;DR AI</span>, our mission is simple: to make knowledge accessible and effortless. We believe that in a world of information overload, clarity is the most valuable asset. We built TLDR AI to be your intelligent partner, helping you cut through the noise and get straight to the point.
                        </p>
                    </div>
                    ...
                    <div class="max-w-4xl mx-auto">
                        ...
                        <p class="text-gray-700 dark:text-gray-300">
                            We've all been there—faced with a dense report, a lengthy research paper, or a mountain of documents and not enough time to read them all. The '<span class="text-tldr-primary">T</span>oo <span class="text-tldr-primary">L</span>ong<span class="text-tldr-primary">;</span> <span class="text-tldr-primary">D</span>idn't <span class="text-tldr-primary">R</span>ead' <span class="text-tldr-primary">(TL;DR)</span> shorthand isn't a sign of laziness; it's a cry for efficiency. Manually summarizing text is slow, prone to error, and often misses crucial details. This bottleneck prevents us from being as informed and productive as we could be.
                        </p>
                    </div>
                ...
                <div class="p-6 text-center">
                    ...
                    @else
                        <a href="{{ route('register') }}" class="inline-flex items-center px-4 py-2 bg-tldr-primary dark:bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white dark:text-tldr-primary uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">

<x-full-width-layout>
    <div class="relative min-h-screen flex flex-col items-center justify-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        ...
        <div class="mt-2 mb-6 text-center max-w-4xl px-4">
            <img src="{{ asset('images/tldr-ai-logo.svg') }}" alt="TLDR AI Logo" class="mx-auto mb-6 h-32 block dark:hidden">
            <img src="{{ asset('images/tldr-ai-logo-dark.svg') }}" alt="TLDR AI Logo" class="mx-auto mb-6 h-32 hidden dark:block">
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 dark:text-white leading-tight">
                <span class="text-tldr-primary">T</span>oo <span class="text-tldr-primary">L</span>ong; <span class="text-tldr-primary">D</span>idn't <span class="text-tldr-primary">R</span>ead? <br>Now you can, with <span class="text-tldr-primary">AI</span>.
            </h1>
        </div>
        ...
        <div class="text-center max-w-3xl px-4">
            ...
            <p class="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed mb-10">
                <strong class="text-tldr-primary">TL;DR AI</strong> is your smart solution. Upload any long document and instantly receive a concise, <span class="text-tldr-primary">AI</span>-powered summary, highlighting the crucial points you need to know.
            </p>

            <div class="flex flex-col sm:flex-row justify-center gap-4 mb-12">
                <a href="{{ route('register') }}" class="inline-flex items-center px-4 py-2 bg-tldr-primary border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150">
